...
public class UsuarioServicio implements UserDetailsService {
     ...
     */
    @Transactional
    public void registrar(MultipartFile archivo, String nombre, String dni, String telefono, String mail, String clave, String clave2) throws IOException, Exception {
        // Antes de persistir, hay que asegurarse de que los datos obligatorios no lleguen vacíos (sean válidos).
        validar(nombre, dni, telefono, mail, clave, clave2);
        ...
        validarContrasena(clave, clave2);
     ...
     * 
     */    
    public void validarContrasena(String clave, String clave2) throws ErroresServicio {
        ...
        if (clave2 == null || clave2.trim().isEmpty()) {
            throw new ErroresServicio("Debe repetir la clave");
        }

        if (clave.length() < 6) {
            throw new ErroresServicio("La clave debe tener al menos 6 caracteres");
        }

        if (!clave.equals(clave2)) {
            throw new ErroresServicio("Las claves no coinciden");
        }
     ...
     */
    @Transactional
    public void modificar(String id, MultipartFile archivo, String nombre, String dni, String telefono, String mail, String clave, String clave2) throws Exception {
        // Antes de persistir, hay que asegurarse de que los datos obligatorios no lleguen vacíos (sean válidos).
        validar(nombre, dni, telefono, mail, clave, clave2);
     ...
     * @throws Exception
     */
    public void validar(String nombre,  String dni, String telefono, String mail, String clave, String clave2) throws Exception {
    ...
    public UserDetails loadUserByUsername(String mail) throws UsernameNotFoundException {
        ...
        if (usuario != null) {
            ...
            // Esto permite guardar el OBJETO USUARIO LOG, para luego ser utilizado:
            ServletRequestAttributes attr = (ServletRequestAttributes) RequestContextHolder.currentRequestAttributes();
            HttpSession session = attr.getRequest().getSession(true);
            session.setAttribute("usuariosession", usuario);
            // Traemos mail y clave del usuario para iniciar sesión; también la lista de permisos
